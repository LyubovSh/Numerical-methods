#Разработать и сравнить эффективность прямого метода циклической прогонки, итерационного метода Гаусса, метода Холецкого и метода наискорейшего спуска с трехдиагональной* системой разного размера. Сравнение будет проводиться по таким критериям, как скорость сходимости, вычислительная сложность и точность полученного решения.
import numpy as np
import time
